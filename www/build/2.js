...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_details__ = __webpack_require__(805);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cart_cart__ = __webpack_require__(487);
...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(navCtrl, navParams, storage, toastCtrl, modalCtrl, WP) {
        ...
        this.WooCommerce.getAsync('products/reviews/' + this.product.id).then(function (data) {
            _this.reviews = JSON.parse(data.body);
            console.log(_this.reviews);
            for (var k = 0; k <= _this.product.length; k++) {
                _this.reviews2.push(_this.reviews[k]);
            }
        }, function (err) {
            console.log();
        });
